defmodule BeamWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BeamWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-black hover:bg-blue-900 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeamWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeamWeb.Gettext, "errors", msg, opts)
    end
  end
